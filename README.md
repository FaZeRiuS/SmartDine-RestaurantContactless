...
- **Розумні рекомендації**: Алгоритми cross-sell ("часто купують разом") та персоналізовані поради на основі історії користувача.
- **Система замовлень**: Керування кошиком, вибір кількості та миттєве оформлення замовлення.
- **Система лояльності та відгуки**: Накопичення бонусів, оплата бонусними балами, залишення чайових, а також відгуків про страви й обслуговування.
...
- **PWA та Web-Push**: Встановлення додатка на смартфон і отримання сповіщень про готовність замовлення чи виклики.
