...
public class CartController {
    ...
    public ResponseEntity<CartResponseDto> addItemToCart(@Valid @RequestBody CartItemDto itemDto) {
        ...
        if (active.isPresent()) {
            throw new ConflictException(
                    "У вас вже є активне замовлення. Додавання страв до кошика тимчасово недоступне.");
        }
    ...
    public ResponseEntity<CartResponseDto> updateCartItemQuantity(
        ...
        return ResponseEntity
                .ok(cartService.updateCartItemQuantity(currentUserIdentity.currentUserId(), itemId, quantity));
    }
    ...
    public ResponseEntity<CartResponseDto> updateCartItemSpecialRequest(
        ...
        return ResponseEntity.ok(cartService.updateCartItemSpecialRequest(currentUserIdentity.currentUserId(), itemId,
